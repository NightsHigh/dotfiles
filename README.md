...
![App Launcher Screenshot](https://raw.githubusercontent.com/eske4/dotfiles/main/images/app-launcher.png)
...
1. Leave Root:
   `su your-username`
2. Clone repo to
   `git clone https://github.com/NightsHigh/dotfiles.git ~/dotfiles`
